...
public class CommonUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = HandyAPP.getInstance().getResources().getDisplayMetrics().density;
    ...
    public static boolean isNetworkConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) HandyAPP.getInstance().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
